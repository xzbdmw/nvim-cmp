...
view.open_docs = function(self)
  ...
  if e then
    e:resolve(vim.schedule_wrap(self.resolve_dedup(function()
      ...
      self.docs_view:open(e, self:_get_entries_view():info(), self:_get_entries_view())
    end)))
  end
end
...
view.select_cur_item = function(self, option)
  self:_get_entries_view():select_cur_item(option)
end
